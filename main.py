...
def help():
    ...
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ══╦═════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╔═════════╩═════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"layer7   "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Afficher Layer7 Methods                "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"layer4   "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Afficher Layer4 Methods                "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"tools    "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Afficher les tools                     "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"credit   "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Afficher les credit                    "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"exit     "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Fermer Lunar DDoS                      "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╠═════════════════════════════════════════════════════╣\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Merci    "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" Merci d'utilisé Lunar.                "+Fore.LIGHTRED_EX+" ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"♥        "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" likez le projet s'il vous plait :)     "+Fore.LIGHTRED_EX+"║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"║ \x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX+"Github   "+Fore.LIGHTRED_EX+"|"+Fore.LIGHTWHITE_EX+" github.com/yemen1337/Lunar-DDos    "+Fore.LIGHTRED_EX+"    ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"╚═════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def credit():
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╗\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Developer "+Fore.RED+": \x1b[38;2;0;255;189myemen\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"UI Design "+Fore.RED+": \x1b[38;2;0;255;189myemen\n")
    stdout.write("\x1b[38;2;255;20;147m• "+Fore.LIGHTWHITE_EX   +"Methods/Tools "+Fore.RED+": \x1b[38;2;0;255;189myemen\n")
    stdout.write("\x1b[38;2;0;236;250m════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def title():
    ...
    stdout.write("                                 "+Fore.LIGHTRED_EX  +"`MM'                                          \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM                                           \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM     ___   ___ ___  __      ___   ___  __  \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM     `MM    MM `MM 6MMb   6MMMMb  `MM 6MM  \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM      MM    MM  MMM9 `Mb 8M'  `Mb  MM69   \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM      MM    MM  MM'   MM     ,oMM  MM'     \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM      MM    MM  MM    MM ,6MM9'MM  MM      \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX  +" MM      MM    MM  MM    MM MM'   MM  MM      \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX   +" MM    / YM.   MM  MM    MM MM.  ,MM  MM      \n")
    stdout.write("                                 "+Fore.LIGHTRED_EX   +"_MMMMMMM  YMMM9MM__MM_  _MM_`YMMM9'Yb_MM_     \n")
    stdout.write("             "+Fore.LIGHTRED_EX            +"        ══╦══════════════════════════════════════════════════════╦══\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"╔═════════╩══════════════════════════════════════════════════════╩═════════╗\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +" Bienvenue dans l'écran d'accueil de Lunar  "+Fore.LIGHTRED_EX  +"                             ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +" Écrivez [help] pour voir les commandes    "+Fore.LIGHTRED_EX +"                              ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"║ "+Fore.LIGHTWHITE_EX   +" Vous voulez me contactez ? Ajoutez yemen#1337 sur discord !   "+Fore.LIGHTRED_EX +"          ║\n")
    stdout.write("             "+Fore.LIGHTRED_EX+"╚══════════════════════════════════════════════════════════════════════════╝\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTRED_EX+"╔═══"+Fore.LIGHTRED_EX+"[""root"+Fore.LIGHTWHITE_EX+"@"+Fore.LIGHTRED_EX+"yemen"+Fore.RED+"]"+Fore.LIGHTRED_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.RED)
    command = input()
...
##############################################################################################     
        ...
        try:
            ...
            print("Une erreur s'est produite lors de l'envoi de la demande à l'API!")
        ...
        stdout.write(Fore.RED+" [>] "+Fore.WHITE+"Commande inconnue. tapez 'help' pour voir toutes les commandes.\n")
##############################################################################################   
...
if __name__ == '__main__':
    ...
    if method == "cfb":
        ...
        if get_cookie(target):
            ...
            stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE+"Échec du bypass cf\n")
    elif method == "cfsoc":
        stdout.write(Fore.MAGENTA+" [*] "+Fore.WHITE+"Bypassing CF... (Max 60s)\n")
        if get_cookie(target):
            timer = threading.Thread(target=countdown, args=(t,))
